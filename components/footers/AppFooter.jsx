  ...
  return (
    <footer className="bottom-0 w-full px-10 text-gray-600 border-t-2 border-gray-200 shadow-md dark:text-gray-400 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 body-font">
              ...
              <div className="flex flex-col flex-wrap justify-center xl:flex-nowrap md:flex-nowrap lg:flex-wrap md:justify-start">
                ...
                /> */}
                  <button
                    ...
                    className={"inline-flex justify-end px-6 py-2 ml-4 text-xs text-white transition duration-300 ease-in-out border-0 rounded-xl lg:mt-2 xl:mt-0 focus:outline-none focus:ring-2 focus:ring-offset-2 " + (alreadySubscribed ? "bg-green-500 focus:ring-green-500 hover:bg-green-600" : "bg-blue-500 focus:ring-blue-500 hover:bg-blue-600")}
                  >
      ...
      <div className="container flex flex-col items-center px-5 py-8 mx-auto sm:flex-row">
        ...
        <p className="mt-4 text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 dark:border-gray-800 sm:py-2 sm:mt-0">
          © 2021 Floriaaan —
          <a
