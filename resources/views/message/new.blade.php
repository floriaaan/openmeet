            ...
            <div class="hidden lg:flex flex-col lg:w-1/4 py-4 pl-6 pr-2 bg-white flex-shrink-0">
                ...
                <div class="flex flex-col mt-8">
                    <div class="flex flex-row items-center justify-between text-xs">
                        ...
                        <span class="flex items-center justify-center bg-gray-200 font-bold h-4 w-4 rounded-full">
                            {{ count($conversations_list) }}
                        </span>
                    </div>
                    <div class="flex flex-col space-y-1 mt-4 -mx-2 max-h-96 overflow-y-auto">
                        <a href="{{ route('message.new') }}"
                            ...
                            <div class="ml-2 flex flex-col">
                                <h6 class="text-md font-semibold">{{ __('messages.message.conversation.create') }}
                                </h6>
