<x-app-layout>
    ...
    <div>
          ...
          <div class="space-y-4">
            <div class="flex flex-col items-start space-y-3 sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3">
              ...
              <div class="space-y-2">
                ...
                <p class="text-base font-normal text-gray-600 dark:text-gray-300">
                  You may return to
                  <a href="/" class="text-primary-600 hover:underline dark:text-primary-500">home page</a> or try
        ...
        <div class="min-w-screen  bg-primary-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
            <div
                ...
                <div class="w-full md:w-1/2">
                    <div class="mb-10 lg:mb-20 flex flex-row items-center">
                        <x-jet-application-mark class="w-10 h-10" />
                        <h4 class="font-bold ml-4 text-2xl">OpenMeet</h4>
                    </div>
                    <div class="mb-10 md:mb-20 text-gray-600 font-light">
                        <h1 class="font-black uppercase text-3xl lg:text-5xl text-primary-500 mb-10">You seem to be
                            lost!</h1>
                    ...
                    <div class="mb-20 md:mb-0">
                        <a href="/"
                            class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-primary-500 hover:text-primary-600"><i
                                class="mdi mdi-arrow-left mr-2"></i>Go Back</a>
                    </div>
                </div>
            ...
            <div
                class="w-64 md:w-96 h-96 md:h-full bg-primary-200 bg-opacity-30 absolute -top-64 md:-top-96 right-20 md:right-32 rounded-full pointer-events-none -rotate-45 transform">
            </div>
            <div
                class="w-96 h-full bg-primary-200 bg-opacity-20 absolute -bottom-96 right-64 rounded-full pointer-events-none -rotate-45 transform">
            </div>
        </div>
