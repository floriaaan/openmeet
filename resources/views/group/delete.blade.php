...
@section('content')
    ...
    <div class="container p-5">
        ...
        <div class="card shadow-lg glow-danger p-3" style="opacity: 0.8">
            ...
            <h3 class="display-4 text-center mt-4">Voulez-vous vraiment supprimer <br> {{$group->name}} ?</h3>
            <hr class="mx-3 my-5">
            ...
            <div class="mt-3 d-flex justify-content-end">
                ...
                <div class="mx-2">
                    ...
                    <form id="confirm" action="{{ url('/groups/delete/') }}" method="POST" style="display: none;">
                        @csrf
