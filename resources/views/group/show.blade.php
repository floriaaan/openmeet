<x-app-layout>
    ...
    <div class="lg:flex lg:items-center lg:justify-between p-7 md:px-24">
        <div class="flex-1 min-w-0">
            ...
            <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                ...
                <div class="mt-2 flex items-center text-sm text-gray-500">
                    ...
                    {{ __('messages.created') }} {{ utf8_encode(strftime('%a %d %b %T', strtotime($group->created_at))) }}
                </div>
            </div>
        </div>
