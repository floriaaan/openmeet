@extends('group.admin.resources.views.layouts.nav')
                            ...
                            @if(!empty($groupList))
                                ...
                                @foreach($groupList as $group)
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-primary badge-pill" >{{ $groupCount }}</span></td>
                            ...
                            @if(!empty($eventList))
                                ...
                                @foreach($eventList as $event)
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-primary badge-pill">{{ $eventCount }}</span></td>
