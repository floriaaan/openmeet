            ...
            <div class="col-lg-9">
                ...
                <div>
                    ...
                    <div class="table-responsive">
                        ...
                        <a href="{{url('/admingroup/subscriptions/')}}" class="btn btn-primary float-right">Voir
                            plus</a>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <a href="{{url('/admingroup/reports/')}}" class="btn btn-primary float-right">Voir plus</a>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="table-responsive">
                                ...
                                @if(!empty($groupList))
                                    ...
                                    @foreach($groupList as $group)
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-primary badge-pill">{{ $groupCount }}</span>
                                            </td>
                            ...
                            <a href="{{url('/admingroup/groups/')}}" class="btn btn-primary float-right">Voir plus</a>
                        </div>
