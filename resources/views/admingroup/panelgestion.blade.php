    ...
    <div class="container position-relative" style="height: 100%">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div>
                    <h4 id="users" class="my-5">Abonnement (5 derniers abonnement)</h4>
                    <div class="table-responsive">
                        ...
                        <a href="{{url('/groups/admin/subscriptions/')}}" class="btn btn-primary float-right">Voir
                            plus</a>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <a href="{{url('/groups/admin/reports/')}}" class="btn btn-primary float-right">Voir plus</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <a href="{{url('/admingroup/bans/')}}" class="btn btn-primary float-right">Voir plus</a>
                    </div>
                    ...
                    <div>
                        <h4 id="groups" class="my-5">Mes groupes (10 groupes)</h4>
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <thead class="thead-dark">
                                <tr>
                                ...
                                @if(!empty($groupList))
                                    ...
                                    @foreach($groupList as $group)
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-primary badge-pill">test</span></td>
                            ...
                            <a href="{{url('/admin/group/groups/')}}" class="btn btn-primary float-right">Voir plus</a>
                        </div>
                        ...
                        <div class="table-responsive">
                                ...
                                @if(!empty($eventList))
                                    ...
                                    @foreach($eventList as $event)
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-primary badge-pill">{{ $eventCount }}</span>
                                            </td>
                            ...
                            <a href="groups/admin/events/" class="btn btn-primary float-right">Voir plus</a>
                        </div>
