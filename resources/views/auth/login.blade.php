            ...
            <div class="card mx-auto w-50">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::label('user_mail', "Adresse mail", ['class' =>'control-label']) !!}
                        {!! Form::email('user_mail', $value = null, ['class' => 'form-control', 'placeholder' => 'jean.dupont@email.fr']) !!}
                        {!! $errors->first('user_mail', '<small class="text-danger">Le champ Adresse mail est incorrect.</small>') !!}
