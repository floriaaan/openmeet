            ...
            <div class="col-lg-9">
                <div>
                    <div class="row justify-content-between">
                        ...
                        <svg id="cb7db7bb-371f-430c-ab8e-9f8547f8cfe6" data-name="Layer 1"
                             xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" width="1130" height="868.1"
                             viewBox="0 0 1130 868.1">
                            <defs>
                                <linearGradient id="be60935f-ac8f-4117-88a8-c3e19524f342" x1="340.5" y1="874.69"
                                                x2="340.5" y2="452.37"
                            ...
                            <path
                                ...
                                transform="translate(-35 -15.95)" fill="var(--openmeet)" opacity="0.1"/>
                            <ellipse cx="499.98" cy="855.15" rx="289.98" ry="12.94" fill="var(--openmeet)"
                                     opacity="0.1"/>
                            <path
                            ...
                            <rect x="221.98" y="250.98" width="101.33" height="9.33" fill="var(--openmeet)"
                                  opacity="0.5"/>
                            <rect x="221.98" y="283.15" width="101.33" height="9.33" fill="var(--openmeet)"
                                  opacity="0.5"/>
                            <rect x="221.98" y="315.32" width="101.33" height="9.33" fill="var(--openmeet)"
                                  opacity="0.5"/>
                            <rect x="221.98" y="347.48" width="101.33" height="9.33" fill="var(--openmeet)"
                                  opacity="0.5"/>
                            <rect x="221.98" y="379.65" width="101.33" height="9.33" fill="var(--openmeet)"
                                  opacity="0.5"/>
                            <rect x="221.98" y="411.82" width="101.33" height="9.33" fill="var(--openmeet)"
                                  opacity="0.5"/>
                            <rect x="221.98" y="443.98" width="101.33" height="9.33" fill="var(--openmeet)"
                                  opacity="0.5"/>
                            ...
                            <path d="M347.15,554.57l7.41,30.4S360.39,584.94,347.15,554.57Z"
                                  transform="translate(-35 -15.95)" opacity="0.1"/>
                            <path d="M372.45,549.48s-9.7,15.88-5.91,32.29l1.8.13S365.12,574.3,372.45,549.48Z"
                            ...
                            <path d="M393.13,740.94s-5.46,3.41-5.64,5.36,2.82-1.42,2.82-1.42Z"
                                  transform="translate(-35 -15.95)" opacity="0.1"/>
                            <path
                                d="M395.28,767.08a11.33,11.33,0,0,1-6.72,2.62c-4.08.18-3.74,5.5-1.07,3.9S395.28,767.08,395.28,767.08Z"
                                transform="translate(-35 -15.95)" opacity="0.1"/>
                            <path d="M396.32,770.49s-2.62,12.86-4.75,10.38" transform="translate(-35 -15.95)"
                                  opacity="0.1"/>
                            <g opacity="0.5">
