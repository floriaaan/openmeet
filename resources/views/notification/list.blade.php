...
@section('content')
    ...
    <div class="container p-5 h-100">
        ...
        <div class="row justify-content-between">
            <h3 class="display-4 my-auto">Toutes vos notifications </h3>

            <svg id="a811ccc3-bd41-4105-81cf-f3cac7d18e76" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                 width="1106" height="794.90955" viewBox="0 0 1106 794.90955"><title>notify</title>
                ...
                <path
                    ...
                    transform="translate(-47 -52.54523)" fill="var(--openmeet)"/>
                <path
                ...
                <path
                    ...
                    transform="translate(-47 -52.54523)" fill="#2f2e41"/>
                <path d="M901.02735,149.12433s-1.21823,12.74983-18.53856,15.14042l-3.77364-11.953,11.953-10.35923Z"
                      transform="translate(-47 -52.54523)" fill="#d0cde1"/>
                <circle cx="428.50536" cy="500.59912" r="86" fill="var(--openmeet)"/>
                <path
                ...
                <path
                    d="M431.7647,425.42408l-.00011,0a67.42193,67.42193,0,0,1-83.03721-36.49526L255.5083,179.57546A90.274,90.274,0,0,1,309.26257,57.269l.00018-.00007a90.27406,90.27406,0,0,1,116.8094,65.87319l50.04222,223.63905A67.42192,67.42192,0,0,1,431.7647,425.42408Z"
                    transform="translate(-47 -52.54523)" opacity="0.1"/>
                <circle cx="425.32461" cy="491.11847" r="69" fill="var(--openmeet)"/>
                <path
