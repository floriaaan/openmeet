        ...
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <div class="hidden md:flex lg:w-2/5 pl-5 flex-wrap space-x-10 items-center text-base md:ml-auto">
            <div class="relative text-gray-600 w-2/3">
                <input type="search" name="serch" placeholder="{{ __('messages.search') }}" class="bg-white w-full border-gray-50 hover:border-primary-300 focus:border-primary-400 border-2 transition duration-300 h-10 px-5 pr-10 rounded-full text-sm focus:outline-none">
                    ...
                    @auth
                        ...
                        @else
                            <span class="rounded-md">
                                <button style="margin-top: 5px" type="button" class="inline-flex items-center  border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
