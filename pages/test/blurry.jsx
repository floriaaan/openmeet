    ...
    <AppLayout>
      <div className="flex items-center justify-center h-full px-16 bg-gray-50 dark:bg-gray-900">
        <div className="relative w-full max-w-lg">
          <div className="absolute top-0 bg-purple-300 rounded-full dark:bg-purple-700 animate-blob filter blur-xl mix-blend-multiply -left-1 w-72 h-72"></div>
          <div className="absolute top-0 bg-yellow-300 rounded-full dark:bg-yellow-700 animate-blob filter blur-xl mix-blend-multiply -right-4 w-72 h-72 animation-delay-2000"></div>
          <div className="absolute bg-green-300 rounded-full dark:bg-green-700 w-72 h-72 animate-blob filter blur-xl mix-blend-multiply -bottom-8 -right-16 animation-delay-4000"></div>
          <div className="absolute bg-red-300 rounded-full dark:bg-red-700 w-72 h-72 animate-blob filter blur-xl mix-blend-multiply -bottom-16 -left-1 animation-delay-4000"></div>
