      ...
      <div className="relative py-16 overflow-hidden bg-white dark:bg-black">
        <div className="hidden lg:block lg:absolute lg:inset-y-0 lg:h-full lg:w-full">
          ...
          >
            ...
            <svg
              className="absolute transform -translate-x-32 -translate-y-1/4 top-1/4 right-full"
              width={404}
              height={384}
              fill="none"
              viewBox="0 0 404 384"
            ...
            <svg
              className="absolute transform translate-x-32 -translate-y-1/2 top-1/2 left-full"
              width={404}
              height={384}
              fill="none"
              viewBox="0 0 404 384"
        ...
        . */}
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to OpenMeet.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to OpenMeet, accessible from{" "}
                  <a
                    href="openmeet.dev"
            ...
            <ul>
              <li>By email: contact@openmeet.dev</li>
            </ul>
          </div>
        </div>
      </div>
