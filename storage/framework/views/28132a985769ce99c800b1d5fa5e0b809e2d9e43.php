<?php $__env->startSection('body'); ?>
    ...
    <div class="navbar navbar-expand-lg navbar-light navbar-custom fixed-top justify-content-between"
        ...
        <div class="collapse navbar-collapse flex-row-reverse " id="navToggle">
            ...
            <?php if(auth()->check()): ?>
                <div class="dropleft nav-responsive-patch ml-1">
                    <?php if(!empty($notifsnav)): ?>
                        <a class="nav-link" href="#" id="navDrop" role="button" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-lg fa-bell"></i>
                            <span
                                class="badge badge-pill badge-danger openmeet-badge"><?php echo e(count((new \App\Notification)->getAllUser(auth()->id()))); ?></span>
                        </a>
                        <div class="dropdown-menu" style="padding: 0" aria-labelledby="navDrop">
                            <div class="card-header">
                                Notifications
                            </div>
                            <?php $__currentLoopData = $notifsnav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php elseif($notif->type=='sub'): ?>
                                    <a class="dropdown-item" href="<?php echo e(url('/groups/show/'.$notif->concerned)); ?>">
                                        <h6 class="dropdown-header mb-1 font-weight-bold">
                                ...
                                <?php elseif($notif->type=='rep'): ?>
                                    <a class="dropdown-item" href="<?php echo e(url('/admin/reports/show/'.$notif->concerned)); ?>">
                                        <h6 class="dropdown-header mb-1 font-weight-bold">
                                            <i class="fas fa-shield-alt text-primary"></i> <?php echo e($notif->title); ?></h6>
                                        <p class="text-muted font-weight-light"><?php echo e($notif->content); ?></p>
                                        <hr class="my-4">
                                        <footer class="blockquote-footer">
                                            <small class="text-muted">
                                ...
                                <?php elseif($notif->type=='eve'): ?>
                                    <a class="dropdown-item" href="<?php echo e(url('/events/show/'.$notif->concerned)); ?>">
                                        <h6 class="dropdown-header mb-1 font-weight-bold">
            ...
            <?php if(auth()->check()): ?>
                ...
                <?php if((new \App\Message)->getCountUnread(auth()->id()) != 0): ?>
                    <a class="nav-link" href="<?php echo e(url('/messages')); ?>" style="margin-right: -25px">
                        <i class="fas fa-lg fa-envelope"></i>
                        <span
                            class="badge badge-pill badge-danger"
                            style="top:-12px; right: 7px; position: relative">
                            <?php echo e((new \App\Message)->getCountUnread(auth()->id())); ?>
